/* =============================================
   FUSION BLAST — SERVICE WORKER
   Cache-first strategy · Offline support
   ============================================= */

const CACHE_NAME = 'fusion-blast-v1.0.0';

const PRECACHE_ASSETS = [
  '/Fusion-Blast/',
  '/Fusion-Blast/index.html',
  '/Fusion-Blast/manifest.json',
  '/Fusion-Blast/icon-192.png',
  '/Fusion-Blast/icon-512.png',
];
        ...
        return fetch(event.request)
          ...
          .catch(() => {
            ...
            if (event.request.destination === 'document') {
              return caches.match('/Fusion-Blast/index.html');
            }
          });
      })
  );
